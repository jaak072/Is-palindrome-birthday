const bdayInput = document.querySelector("#input-date");
...
function showOutLoader(){
    loader.style.display = "none";
} 
function outShowHide(){
...
function clickHandler(e) {
    if(bdayInput.value){
        ...
        setTimeout(showOutLoader,4000);
        setTimeout(outShowHide,4022);
        ...
        if (!isPalindrome) {
            ...
            if (ctr1 > ctr2) {
                outputE1.style.color = "rgb(204, 48, 48)";
                outputE1.innerText = `The nearest palindrome date is ${prevDate.day}-${prevDate.month}-${prevDate.year}, you missed by ${ctr2} days.`;
            } else {
                outputE1.style.color = "rgb(33, 61, 138)";
                outputE1.innerText = `The nearest palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed by ${ctr1} days.`;
            }
    
        } else {
            outputE1.style.color = "green";
            outputE1.innerText = 'Yay! Your birthday is palindrome!';
        ...
        outputE1.innerText = 'Ohho!! Choose your Birth Date...!🙄';
    }
}
